  ...
  render() {
    return (
      <div className="keypad-container">
        ...
        <button name="percentage" onClick={event => this.props.onClick(event.target.name)}>%</button><br/>
        <button name="/" onClick={event => this.props.onClick(event.target.name)}>/</button><br/>
        ...
        <button name="*" onClick={event => this.props.onClick(event.target.name)}>x</button><br/>
